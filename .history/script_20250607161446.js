    ...
    displayCommand(command) {
        ...
        commandLine.innerHTML = `
            <span class="prompt-output">
                <span class="user">visitor@hieu-terminal</span><span class="separator">:</span><span class="path">~</span><span class="dollar">$</span>
            </span>
    ...
    showWelcomeMessage() {
        this.displayOutput(`
            <div class="welcome-msg">
                <p style="color: #00ffff;">Welcome to Hieu Le's Interactive Terminal!</p>
    ...
    showAbout() {
        this.displayOutput(`
            <div class="about-content">
                <h3 style="color: #00ffff; margin-bottom: 15px;">About Hieu Le</h3>
                <p><span style="color: #00ff00;">Name:</span> Hieu Le</p>
                <p><span style="color: #00ff00;">Title:</span> Senior DevSecOps Engineering / Site Reliability Engineering</p>
                <p><span style="color: #00ff00;">Email:</span> phuonghieuag@gmail.com</p>
                <p><span style="color: #00ff00;">Phone:</span> 0975 669 775</p>
                <p><span style="color: #00ff00;">Location:</span> Vietnam</p>
                ...
                <p style="margin-top: 15px; color: #cccccc;">
                    Passionate about cloud infrastructure, automation, security, and building reliable systems at scale.
                    Experienced with AWS, Kubernetes, Docker, Terraform, and various programming languages.
                </p>
            </div>
        `);
    }
        ...
        this.displayOutput(`
            <div class="skills-content">
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <p style="color: #cccccc;">Python, C/C++, PHP, Golang, Java, JavaScript, C#, Shell Script</p>
                </div>
                <div style="margin-bottom: 15px;">
                    <h4 style="color: #ffff00;">DevOps & Cloud:</h4>
                    <p style="color: #cccccc;">AWS (RDS, EC2, ASG, EKS, S3, Route53, IAM, AMI, MSK, ElasticCache, Security Hub), Microsoft Azure, OpenShift, Docker, Kubernetes, Terraform, Helm/Helmfile, Ansible, Jenkins, GitLab-CI, GitOps, Puppet, Prowler, Trivy, Falco, OPA</p>
                </div>
                <div style="margin-bottom: 15px;">
                    <h4 style="color: #ffff00;">Databases:</h4>
                    <p style="color: #cccccc;">TiDB, MySQL, MariaDB, Oracle Database, PostgreSQL, Redis, Memcache, Kafka, Apache Kudu, Hadoop, Impala</p>
                </div>
                <div>
                    <h4 style="color: #ffff00;">Monitoring & Tools:</h4>
                    <p style="color: #cccccc;">Grafana, Prometheus, Node Exporter, Robot Framework, Spring MVC, Networking, Cloud Enterprise</p>
                </div>
            </div>
        `);
    }
    ...
    showExperience() {
        this.displayOutput(`
            <div class="experience-content">
                ...
                <div style="margin-bottom: 15px;">
                    <h4 style="color: #ffff00;">Parcel Perform - DevOps Engineer (2021-2022)</h4>
                    <p style="color: #cccccc;">Implemented CI/CD pipelines, managed AWS infrastructure, automated deployment processes using Terraform, integrated security scanning tools for vulnerability assessment.</p>
                </div>
                <div style="margin-bottom: 15px;">
                    <h4 style="color: #ffff00;">Home Credit - DevOps Engineer (2021-2022)</h4>
                    <p style="color: #cccccc;">Managed Microsoft Azure cloud infrastructure, orchestrated Kubernetes clusters, developed automation scripts in Python and Golang for operational efficiency.</p>
                </div>
                <div style="margin-bottom: 15px;">
                    <h4 style="color: #ffff00;">VNG/Zalopay - SRE & DevOps Engineer (2020-2021)</h4>
                    <p style="color: #cccccc;">Maintained critical infrastructure services, managed Kubernetes environments, optimized TiDB and MySQL database performance, ensured system reliability and scalability.</p>
                </div>
                <div style="margin-bottom: 15px;">
                    <h4 style="color: #ffff00;">TMA - Multiple Projects (2018-2020)</h4>
                    <p style="color: #cccccc;">Contributed to diverse projects in healthcare, banking, and CDN sectors. Developed scalable solutions and implemented best practices across various technology stacks.</p>
                </div>
                <div>
                    <h4 style="color: #ffff00;">HDVnBits.Org - System Administrator (2012-2017)</h4>
                    <p style="color: #cccccc;">Administered P2P systems and Linux server environments, managed system security and performance optimization.</p>
                </div>
            </div>
        `);
    }
    ...
    showContact() {
        this.displayOutput(`
            <div class="contact-content">
                ...
                <p><span style="color: #00ff00;">📧 Email:</span> <a href="mailto:phuonghieuag@gmail.com" style="color: #ffff00;">phuonghieuag@gmail.com</a></p>
                <p><span style="color: #00ff00;">📞 Phone:</span> <a href="tel:+84975669775" style="color: #ffff00;">0975 669 775</a></p>
                <p><span style="color: #00ff00;">🌍 Location:</span> Vietnam</p>
                <p><span style="color: #00ff00;">📄 Resume:</span> <a href="LePhuongHieu_DevSecOps_Resume_v2.pdf" target="_blank" style="color: #ffff00;">Download PDF</a></p>
                <br>
                <p style="color: #00ffff;">💡 Available for:</p>
                <ul style="color: #cccccc; margin-left: 20px;">
                    <li>DevSecOps Engineering positions</li>
    ...
    downloadResume() {
        this.displayOutput(`
            <div class="resume-content">
                ...
                <p style="color: #cccccc;">File: LePhuongHieu_DevSecOps_Resume_v2.pdf</p>
                <p><a href="LePhuongHieu_DevSecOps_Resume_v2.pdf" target="_blank" style="color: #ffff00;">Click here if download doesn't start automatically</a></p>
            </div>
        `);
        
        // Simulate download
        setTimeout(() => {
            window.open('LePhuongHieu_DevSecOps_Resume_v2.pdf', '_blank');
        }, 1000);
    }
    ...
    hireMe() {
        this.displayOutput(`
            <div class="hire-content">
                <h3 style="color: #00ffff; margin-bottom: 15px;">Why Hire Hieu Le?</h3>
                <ul style="color: #cccccc; margin-left: 20px;">
                    <li>🚀 <strong>8+ years</strong> of hands-on DevOps and SRE experience</li>
                    <li>☁️ <strong>Multi-cloud expertise</strong> (AWS, Azure, OpenShift)</li>
                    <li>🔒 <strong>Security-first mindset</strong> with DevSecOps practices</li>
                    <li>📈 <strong>Proven track record</strong> of improving system reliability</li>
                    <li>🛠️ <strong>Full-stack automation</strong> from infrastructure to deployment</li>
                    <li>📊 <strong>Monitoring & observability</strong> expertise</li>
                    <li>🎯 <strong>Problem solver</strong> with strong analytical skills</li>
                    <li>🤝 <strong>Collaborative team player</strong> with leadership experience</li>
                </ul>
                <br>
                <p style="color: #00ff00;">Ready to bring reliability, security, and efficiency to your infrastructure!</p>
                <p style="color: #ffff00;">Contact: phuonghieuag@gmail.com | 0975 669 775</p>
            </div>
        `);
    }
